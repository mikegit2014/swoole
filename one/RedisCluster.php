...
class RedisCluster{  
    ...
    public function sets($keyArray, $timeout) {
        if (is_array($keyArray)) {
            $retRes = $this->getRedis()->mset($keyArray);
            if ($timeout > 0) {
    ...
    public function zadd($key,$value){
        return $this->getRedis()->zadd($key,$value);
    }
    ...
    public function smembers($setName){
        return $this->getRedis()->smembers($setName);
    }
    ...
    //移除列表的值 LREM KEY_NAME COUNT VALUE
    ...
    public function hset($tableName,$field,$value){
        return $this->getRedis()->hset($tableName,$field,$value);
    }
    
    public function hget($tableName,$field){
        return $this->getRedis()->hget($tableName,$field);
    }
    /**
     * 读缓存
     *
    ...
    public function updateName($key,$newKey){
        return $this->getRedis()->RENAMENX($key,$newKey);
    }
    ...
    */
    ...
    public function sort($key,$sort){
        return $this->getRedis()->sort($key,$sort);
    } 
    /* =================== 以下私有方法 =================== */       
    /**
